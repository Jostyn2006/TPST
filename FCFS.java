...
public class FCFS extends Application{
	...
	public void start(Stage finestra) {
		...
		bFa.setOnAction(e -> prova());
	}
	
	private void prova() {
		int nTemArr0 = Integer.parseInt(tempoArrivo0.getText());
		...
		int nTemEse3 = Integer.parseInt(tempoEsecuzione3.getText());
